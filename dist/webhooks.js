...
var stripeWebhookHandler = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var webhookRequest, body, signature, event, session, payload, users, _a, user, orders, _b, order, data, error_1;
    var _c, _d;
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                ...
                session = event.data
                    .object;
                if (!((_c = session === null || session === void 0 ? void 0 : session.metadata) === null || _c === void 0 ? void 0 : _c.userId) ||
                    !((_d = session === null || session === void 0 ? void 0 : session.metadata) === null || _d === void 0 ? void 0 : _d.orderId)) {
                    return [2 /*return*/, res
                            .status(400)
            ...
            case 5:
                ...
                return [4 /*yield*/, resend.emails.send({
                        from: 'Maadsounds <maadsoundinfo@gmail.com>',
                        to: [user.email],

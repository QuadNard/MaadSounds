    ...
    <MaxWidthWrapper className="py-20">
      <FadeIn>
        <div className="flex flex-col items-center space-y-2">
          <div className="relative p-1 rounded-full bg-transparent">
            <motion.img
          ...
          <p className="text-lg font-bold text-[#383732]">
            Beats Producer | Marketer
          </p>
          <div className="my-10 max-w-[58ch] text-[#383732]">
